...
Page.prototype = {
    init: function init() {
        ...
        that.getPages().forEach(function (item) {
            ...
            li.innerHTML = '<a href="'+that.nowpage+'?page='+ item +'">'+item+'</a>';
    ...
    firstPage: function firstPage() {
        var that = this;
        var li = document.createElement('li');
        li.innerHTML = '<a href="'+this.nowpage+'?page=1">首页</a>';
    ...
    lastPage: function lastPage() {
        var that = this;
        var li = document.createElement('li');
        li.innerHTML = '<a href="'+this.nowpage+'?page='+ (this.curPage-1) +'"><</a>';
    ...
    finalPage: function finalPage() {
        var that = this;
        var li = document.createElement('li');
        li.innerHTML = '<a href="'+this.nowpage+'?page='+ this.pageTotal +'">尾页</a>';
        this.ul.appendChild(li);
        li.onclick = function () {
